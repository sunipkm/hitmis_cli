 ...
 * @brief Implementation of Princeton Instruments CameraUnit interfaces
 * @version 0.1
 * @date 2022-01-24
 * 
...
CImageData CCameraUnit_PI::CaptureImage(long int &retryCount)
{
...

    {
        ...
        pl_exp_init_seq();
        imgExposure = uns32(exposure_ * 1000);
        ...
        retVal.SetImageMetadata(imgExposure * 0.001, binningX_, binningY_, GetTemperature(), exposure_start, CameraName());
